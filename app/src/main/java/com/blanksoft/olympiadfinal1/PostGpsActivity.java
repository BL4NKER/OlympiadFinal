...
public class PostGpsActivity extends AppCompatActivity
        ...
        mGoogleMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                ...
                MarkerOptions marker = new MarkerOptions().position(
                        new LatLng(latLng.latitude, latLng.longitude)).title(latLng.toString());
                ...
                markerlong = String.valueOf(latLng.longitude);
    ...
    public void onButton2Clicked(View v) {
        /** String url =  "http://172.20.10.4:3000/process/contentadd";
        ...
        Log.d("gps", makerlat + makerlong);
        params.put("lat", markerlat);
        params.put("long", markerlong);

        Intent intent = new Intent(QuestGpsActivity.this, PostWriteActivity.class);
        intent.putExtra("markerlat", markerlat);
        intent.putExtra("markerlng", markerlong);
    ...
    private void showDialogForPermission(String msg) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(PostGpsActivity.this);
        builder.setTitle("알림");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.menu_add_post:
                ...
                final String URL =  "http://172.20.10.4:3000/process/gps";
                StringRequest request = new StringRequest(Request.Method.POST,
                            ...
                            public void onResponse(String response) {
                                try {
                                    if(response.equals("1")) {
                                        Intent i = new Intent(PostGpsActivity.this, MainActivity.class);
                                        startActivity(i);
                                    } else {
                    ...
                    protected Map<String, String> getParams() {
                        ...
                        Map<String, String> params = new HashMap<>();
                        params.put("markerlat", markerlat);
                        params.put("markerlong", markerlong);
