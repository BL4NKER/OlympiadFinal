...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idText =(AppCompatEditText)findViewById(R.id.id);
        pwText =(AppCompatEditText)findViewById(R.id.pw);
    ...
    private void login(){
        final String URL =  "http://218.155.147.128:3000/process/login";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(num.equals("0")){
                                Toast.makeText(getApplicationContext(), "없는 정보입니다. 다시시도 하십시오.", Toast.LENGTH_LONG).show();
